...
%PLOTBYLOCATION Plots sdf by location
%  Input:
%    sdfStruct : A sdf struct output of call to sdf function
%    trialNoLocationMat: A matrix of [trialNo targetLocation]
%  Output:
